...
function fnInitApexChart() {
    try {
        ...
        $("#SEA_BL_CNT").html("<span>0/</span> <br/>0건");
        $("#SEA_CON_CNT").html("<span>0/</span> <br/>0건");
        $("#AIR_AWB_CNT").html("<span>0/</span> <br/>0건");
        $("#AIR_CON_CNT").html("<span>0/</span> <br/>0건");
        ...
        var chart1 = new ApexCharts(document.querySelector("#sheet_graph1"), options1);
        chart1.render();
        var chart2 = new ApexCharts(document.querySelector("#sheet_graph2"), options2);
        chart2.render();
        var chart3 = new ApexCharts(document.querySelector("#sheet_graph3"), options3);
        chart3.render();
        var chart4 = new ApexCharts(document.querySelector("#sheet_graph4"), options4);
        chart4.render();
    }
    catch (err) {
...
function fnApexChart(TotalJson) {
    try {
        ...
        $("#SEA_BL_CNT").html("<span>" + _fnGetNumber(TotalJson[0].PORT_DATA_CNT, "sum") + " /</span> <br/>" + _fnGetNumber(TotalJson[0].TOT_DATA_CNT, "sum") + " 건");
        $("#SEA_CON_CNT").html("<span>" + _fnGetNumber(Math.ceil(TotalJson[0].PORT_DATA_RTON), "sum") + " /</span> <br/>" + _fnGetNumber(Math.ceil(TotalJson[0].TOT_DATA_RTON), "sum"));
        $("#AIR_AWB_CNT").html("<span>" + _fnGetNumber(TotalJson[1].PORT_DATA_CNT, "sum") + " /</span> <br/>" + _fnGetNumber(TotalJson[1].TOT_DATA_CNT, "sum") + " 건");
        $("#AIR_CON_CNT").html("<span>" + _fnGetNumber(Math.ceil(TotalJson[1].PORT_DATA_RTON), "sum") + " /</span> <br/>" + _fnGetNumber(Math.ceil(TotalJson[1].TOT_DATA_RTON), "sum"));
