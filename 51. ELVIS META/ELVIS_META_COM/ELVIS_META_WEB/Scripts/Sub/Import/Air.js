...
$(function () {
    ...
    $(".sub_imp").addClass("on");
    $(".sub_imp .sub_depth").addClass("on");
    $(".sub_imp .sub_depth li:nth-child(2) a").addClass("on");
    ...
    try {
        ...
        if (JSON.parse(vJsonData).Result[0]["trxCode"] == "Y") {
            ...
            $.each(vResult, function (i) {
                ...
                vHTML += "                   <div class='prog-status__bar'>";
                vHTML += "                       <div class='pog-status__percent'></div>";
                vHTML += "                   </div>";
